  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-[#09090B] flex flex-col font-sans selection:bg-neutral-900 selection:text-white">
      ...
      <header className="sticky top-4 z-50 mx-auto w-full max-w-5xl px-4">
        <nav className="flex items-center justify-between rounded-full border border-neutral-200/80 bg-white/80 px-6 py-3 shadow-xs backdrop-blur-md transition-all">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="flex size-7 items-center justify-center rounded-lg bg-neutral-900 text-white font-bold text-xs tracking-wider">
              WS
            </div>
          ...
          <div className="hidden md:flex items-center gap-8 text-[13px] font-medium text-neutral-500">
            ...
            <a href="#pricing" className="hover:text-neutral-900 transition-colors">Docs</a>
          </div>

          <div className="flex items-center gap-3">
            <Link href="/login">
              <Button variant="ghost" size="sm" className="text-neutral-700 hover:text-neutral-900 font-medium">
                Log in
              </Button>
            </Link>
            <Link href="/signUp">
      ...
      {/* ── Hero Section ────────────────────────────────────────────────────── */}
      <section className="relative pt-20 pb-16 md:pt-28 md:pb-24 px-4 max-w-5xl mx-auto text-center">
        {/* Subtle Pill Tag */}
        ...
        <div className="mt-14 relative rounded-2xl border border-neutral-200/80 bg-white p-3 shadow-xl max-w-4xl mx-auto overflow-hidden">
          <div className="rounded-xl border border-neutral-100 bg-neutral-50/50 p-6 md:p-8 text-left">
            {/* Window bar */}
            <div className="flex items-center justify-between border-b border-neutral-200/60 pb-4 mb-6">
              <div className="flex items-center gap-2">
                ...
                <span className="size-3 rounded-full bg-neutral-200" />
                <span className="size-3 rounded-full bg-neutral-200" />
                <span className="ml-2 text-xs font-mono text-neutral-400">worksphere.app / workspace / engineering</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-xs bg-emerald-50 text-emerald-700 border border-emerald-200 px-2.5 py-0.5 rounded-full font-medium">Live Sync</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="rounded-lg border border-neutral-200/70 bg-white p-4">
                ...
                <div className="text-2xl font-semibold text-neutral-900">12 Projects</div>
                <div className="mt-3 flex items-center gap-1.5 text-xs text-emerald-600 font-medium">
                  <span>↑ 18% from last month</span>
                </div>
              </div>
              <div className="rounded-lg border border-neutral-200/70 bg-white p-4">
                <div className="text-xs font-medium text-neutral-400 mb-1">Tasks Completed</div>
                <div className="text-2xl font-semibold text-neutral-900">148 Tasks</div>
                <div className="mt-3 flex items-center gap-1.5 text-xs text-neutral-500">
                  <span>94% completion rate</span>
                </div>
              </div>
              <div className="rounded-lg border border-neutral-200/70 bg-white p-4">
                <div className="text-xs font-medium text-neutral-400 mb-1">GitHub Sync</div>
                <div className="text-2xl font-semibold text-neutral-900">4 Repositories</div>
                <div className="mt-3 flex items-center gap-1.5 text-xs text-emerald-600 font-medium">
            ...
            {/* Mockup task list */}
            <div className="mt-4 rounded-lg border border-neutral-200/70 bg-white p-4">
              ...
              <div className="space-y-2.5">
                {[
                  ...
                  <div key={i} className="flex items-center justify-between p-2.5 rounded-md bg-neutral-50/70 border border-neutral-100 text-xs">
                    <span className="font-medium text-neutral-800">{item.title}</span>
                    <span className={`px-2 py-0.5 rounded-md border text-[11px] font-medium ${item.tagBg}`}>{item.tag}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      {/* ── Bento Grid Core Values Section ─────────────────────────────────── */}
      <section id="features" className="py-20 px-4 max-w-5xl mx-auto border-t border-neutral-200/60">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="rounded-2xl border border-neutral-200 bg-white p-7 shadow-xs hover:border-neutral-300 transition-all">
      ...
      {/* ── Integrations Wheel Showcase ────────────────────────────────────── */}
      <section id="integrations" className="py-20 px-4 max-w-5xl mx-auto border-t border-neutral-200/60 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-8 flex items-center justify-center shadow-xs">
      ...
      {/* ── Bottom CTA Section ──────────────────────────────────────────────── */}
      <section className="py-24 px-4 bg-white border-t border-neutral-200/80 mt-auto">
      ...
      {/* ── Footer ──────────────────────────────────────────────────────────── */}
      <footer className="border-t border-neutral-200/60 bg-[#FAFAFA] py-16 px-4">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 text-xs">
          <div>
